...
export function handleCommand(
  ...
  if (id === "help" || id === "h") {
    const help = [
      ...
      "**In-Game (Player)**: %move, %use, %dash, %target, %choose, %confirm, %cancel, %endturn, %premove, %passmove, %pathstep, %confirmmove, %cancelpath, %viewreach, %dashmode, %grid, %r, %vote, %votestatus, %unvote, %leave",
