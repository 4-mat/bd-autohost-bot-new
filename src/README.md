...
| `%close`             | `handleClose`        | Closes signups and opens gamemode voting (`voteOpen = true`) for joined players                                                          |
| `%vote`              | `handleVote`         | Casts/changes a player's gamemode vote; options filtered by lobby size (no 3v3 with 4 players)                                           |
